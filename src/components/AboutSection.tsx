        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-10 items-center">
          <div className="order-2 md:order-1">
            ...
            <p className="mb-4 text-muted-foreground">
              Olá! Sou João Silva, fotógrafo profissional com mais de 10 anos de experiência
              capturando momentos e criando memórias visuais inesquecíveis.
            </p>
            <p className="mb-4 text-muted-foreground">
          ...
          <div className="order-1 md:order-2 flex justify-center md:justify-end">
            <div className="relative">
              <img
                src="https://images.unsplash.com/photo-1486718448742-163732cd1544?auto=format&fit=crop&w=600&q=80"
                alt="João Silva - Fotógrafo"
